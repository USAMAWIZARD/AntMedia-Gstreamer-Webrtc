...
static GOptionEntry entries[] =
    {
        ...
        {"streamid", 'i', 0, G_OPTION_ARG_STRING, &stream_id, "stream ID name that you want to join", NULL},
...
static void create_webrtc(gchar *webrtcbin_id, GstWebRTCSessionDescription *offersdp, gboolean send_offer)
{
    ...
    gst_bin_add_many(GST_BIN(gst_pipe), video_q, webrtc, NULL);
...
static void on_socket_connected(rws_socket socket)
{
    ...
    json_object_set_string_member(publish_stream, "streamId", stream_id);
